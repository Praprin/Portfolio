...
Each bug is a separate `BUG-XXX ... .md` card (template: `_TEMPLATE.md`). Attachments are in `attachments/BUG-XXX/`.
...
> Severity is the technical impact of the defect; Priority is how urgently it needs fixing. These are different axes.
